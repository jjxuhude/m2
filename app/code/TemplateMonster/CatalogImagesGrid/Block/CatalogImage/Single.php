 ...
 *
 */
class Single  extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    ...
    {
        if (!$this->_helperCategoryImage->isEnableModule()) {
            return '';
        }
